...
g++ build/defaults.o build/main.o build/Textbox.o build/Scenario.o build/Controller.o build/Settings.o -o TalkToHer -lsfml-graphics -lsfml-window -lsfml-system 
